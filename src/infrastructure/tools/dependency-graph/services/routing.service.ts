...
import { StaticFileEnum } from '@infrastructure/tools/dependency-graph/enum/static-file.enum';
import { RouteNameEnum } from '@infrastructure/tools/dependency-graph/enum/route-name.enum';
